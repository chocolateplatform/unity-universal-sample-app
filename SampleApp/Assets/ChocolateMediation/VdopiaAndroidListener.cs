...
namespace Chocolate
{
    ...
    public class VdopiaAndroidListener : AndroidJavaProxy
    {
        ...
        private static VdopiaAndroidListener instance;
        ...
        private VdopiaAndroidListener() : base("com.vdopia.unity.plugin.VdopiaAdUnityListener")
        {
